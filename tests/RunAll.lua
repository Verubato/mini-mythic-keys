-- Entry point for the MiniMythicKeys test suite. Run from the repository root:
--
...
io.write("MiniMythicKeys - unit tests\n")
io.write("======================================\n")

local testFiles = {
	"tests/TestSmoke.lua",
	"tests/TestToggleWindow.lua",
	"tests/TestFindKey.lua",
	"tests/TestChatCommands.lua",
}
